...
class TestStellarEntrances:
    ...
    def test_enter_by_button_log_in_to_account_in_chrome(self, driver1):
    ...
    def test_enter_by_button_personal_account_in_chrome(self, driver1):
        new_name = f'OksanaMasyarkina8{random.randint(100, 999)}'
        new_email = f'{new_name}@yandex.ru'
        driver1.get(f'{URL}register')
        driver1.find_element(*StellarLocators.NAME_FIELD_REG).send_keys(new_name)
    ...
    def test_enter_by_button_in_form_of_registration_in_chrome(self, driver1):
        new_name = f'OksanaMasyarkina8{random.randint(100, 999)}'
        new_email = f'{new_name}@yandex.ru'
        driver1.get(f'{URL}register')
        driver1.find_element(*StellarLocators.NAME_FIELD_REG).send_keys(new_name)
    ...
    def test_enter_by_button_in_form_of_password_recovery_in_chrome(self, driver1):
        new_name = f'OksanaMasyarkina8{random.randint(100, 999)}'
        new_email = f'{new_name}@yandex.ru'
        driver1.get(f'{URL}register')
        driver1.find_element(*StellarLocators.NAME_FIELD_REG).send_keys(new_name)
